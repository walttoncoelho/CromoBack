  ...
  let empreendimento = await prisma.empreendimento.createMany({
    data: [
      ...
      },
      {
        ...
        descricao: "Entregue em 2016, os Residenciais Veneza I e II são compostos por mil unidades habitacionais do Programa Minha Casa Minha Vida, como parte do Programa Nacional de Habitação Urbana (PNHU) do Governo Federal e construídos em parceria com o Governo do Estado e a Prefeitura Municipal.  As casas possuem sala, cozinha, dois quartos, banheiro e área de serviço, em 42,78 m². Há, ainda, unidades com a estrutura adaptada para pessoas com deficiência.  Com investimentos no valor de R$ 56,9 milhões, as casas beneficiaram famílias com renda familiar mensal de até R$ 1,6 mil, da região de Balsas.",
        tipoEmpreendimento: "Lotes comerciais & residenciais",
